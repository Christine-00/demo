	<?php
        ...
        //$tsql_exec = "Delete from cartDetTemp where UserID = $user_id";
        $tsql_exec = "Delete from cartDetTemp where UserID = $user_id;Delete from cartDetOptionTemp where UserID = $user_id";
